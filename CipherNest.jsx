...
export default function CipherNest(){
  ...
  async function incidentAction(action){
    if(action==="lockdown"){
      setLockdown(true);setTimeout(()=>setLockdown(false),4000);
  ...
  const isSimBorder=isSimMode?{outline:`2px solid ${C.purple}`,animation:"simGlow 2s ease-in-out infinite"}:{};
    ...
    <div style={{background:C.bg,minHeight:"100vh",fontFamily:"'Rajdhani',sans-serif",
      ...
      {lockdown&&<div style={{position:"fixed",inset:0,zIndex:9000,pointerEvents:"none",display:"flex",alignItems:"stretch"}}>
        ...
        <div style={{position:"absolute",top:"45%",left:"50%",transform:"translate(-50%,-50%)",
          fontFamily:"'Orbitron',sans-serif",fontSize:26,fontWeight:900,color:C.red,
          textShadow:`0 0 30px ${C.red}`,letterSpacing:5,animation:"lockFlash .3s ease-in-out infinite"}}>
      ...
      <div style={{display:"flex",alignItems:"center",gap:10,padding:"0 18px",
        ...
        <div style={{display:"flex",gap:3,marginLeft:16}}>
          {[["dashboard","Dashboard"],["simulation","Simulation"],["reports","Reports"],["agents","Agents Manager"]].map(([t,l])=>(
        ...
        <div style={{display:"flex",alignItems:"center",gap:10,marginLeft:"auto",flexWrap:"wrap"}}>
          ...
          <div style={{fontFamily:"'Share Tech Mono',monospace",fontSize:12,color:C.textDim}}>{clock}</div>
    ...
    return<div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:10,padding:"12px 18px"}}>
      {[
        ...
        <div key={m.l} style={{background:C.panel,
          ...
          animation:isSimMode?"simGlow 2s ease-in-out infinite":"none"}}>
  ...
  function AgentLogPanel(){
    return<Panel color={C.cyan}>
      ...
      <div style={{maxHeight:270,overflowY:"auto"}}>
        ...
        {agentLog.map(e=>(
          <div key={e.id} style={{padding:"7px 0",borderBottom:`1px solid ${C.border}`,animation:"fadeSlide .4s ease"}}>
      ...
      <div style={{maxHeight:180,overflowY:"auto"}}>
        ...
        {alerts.map((a,i)=>{
          ...
          return<div key={i} style={{display:"flex",alignItems:"flex-start",gap:8,
            padding:"6px 0",borderBottom:`1px solid ${C.border}`,animation:"fadeSlide .4s ease"}}>
  ...
  function SimulationTab(){
    ...
    return<div style={{padding:18}}>
      <Panel color={C.purple} style={{marginBottom:14,animation:simRunning?"simGlow 2s ease-in-out infinite":"none"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:10,marginBottom:14}}>
        {[{l:"FLOWS PROCESSED",v:totalFlows.toLocaleString(),c:C.cyan},
          ...
          <div key={m.l} style={{background:C.panel,
            ...
            animation:simRunning?"simGlow 2s ease-in-out infinite":"none"}}>
            <div style={{fontFamily:"'Share Tech Mono',monospace",fontSize:8,letterSpacing:2,color:C.textLabel,marginBottom:6}}>{m.l}</div>
      ...
      {simReport&&(
        <Panel color={C.green} style={{animation:"reportIn .5s ease"}}>
          ...
          <div style={{maxHeight:"60vh",overflowY:"auto"}}>
            {reports.map(rpt=>(
              <div key={rpt.id} style={{border:`1px solid ${C.borderBright}`,background:C.card,
                padding:"12px",marginBottom:10,animation:"reportIn .4s ease"}}>
          ...
          <div style={{maxHeight:440,overflowY:"auto"}}>
            ...
            {blockedIPs.map((b,i)=>(
              <div key={i} style={{display:"grid",gridTemplateColumns:"1fr auto",alignItems:"center",
                padding:"7px 0",borderBottom:`1px solid ${C.border}`,animation:"fadeSlide .4s ease"}}>
                <div>
